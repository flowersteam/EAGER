...
def main(args, attr):
    ...
    il_learn = ImitationLearning(args, attr)
...
if __name__ == "__main__":
    ...
    if args.no_answer_question:
        if args.biased and args.env == "BabyAI-PutNextLocal-v0":
            ...
            attr['vocab_path'] = 'storage/demos/{}_agent_done_QG_no_answer_vocab.pkl'.format(args.env)
    else:
        attr['vocab_path'] = 'storage/demos/{}_agent_done_QG_vocab.pkl'.format(args.env)
    print(args)
    print(attr)
    main(args, attr)
